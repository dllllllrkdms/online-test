										...
										<div class="pagination">
											<div class="mb-4">
												<div class="btn-group me-2" role="group" aria-label="First group">
													<a class="btn" href="${pageContext.request.contextPath}/${path}/test/testList?currentPage=1&searchWord=${searchWord}">처음으로</a>
													<a class="btn" href="${pageContext.request.contextPath}/${path}/test/testList?currentPage=${map.startPage-1}&searchWord=${searchWord}">이전</a>
													...
													<a class="btn" href="${pageContext.request.contextPath}/${path}/test/testList?currentPage=${map.endPage+1}&searchWord=${searchWord}">다음</a>
													<a class="btn" href="${pageContext.request.contextPath}/${path}/test/testList?currentPage=${map.lastPage}&searchWord=${searchWord}">끝으로</a>
												</div>												
											</div>
										</div>
									</div>
