...
<div>
	...
	<a href="${pageContext.request.contextPath}/teacher/teacherList">강사관리</a> <!-- 강사목록, 강사삭제 -->
	<a href="${pageContext.request.contextPath}/student/studentList">학생관리</a> <!-- 학생목록, 학생삭제 -->
