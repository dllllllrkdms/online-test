...
<body>
	...
	<script>
		function f(xModel, countStudent){
			$(xModel, countStudent).each(function(index, item){
				let html = '<tr>';
				html += '<td>'+ xModel[index] +'</td>';
				html += '<td>'+ countStudent[index] +'</td>';
				html += '</tr>';
				console.log(html+'<--html');
				
				$('#countStudentTable').append(html);
			});
		}
	</script>
