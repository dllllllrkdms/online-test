							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center mb-3 userSe">
										<a class="btn btn-lg active" href="${pageContext.request.contextPath}/addStudent" rel="student">[학생]</a>
										<a class="btn btn-lg" href="${pageContext.request.contextPath}/addTeacher" rel="teacher">[강사]</a>
									</div>
									
									<form action="${pageContext.request.contextPath}/addStudent" method="post" id="form">
										<div class="mb-3">
											<label class="form-label" for="studentName">이름</label>
											<input class="form-control form-control-lg" type="text" id="studentName" name="studentName" />
											<div class="msg"></div>
										</div>
										<div class="mb-3">
											<label class="form-label" for="studentId">아이디</label>
											<input class="form-control form-control-lg" type="text" id="studentId" name="studentId" />
											<div class="msg"></div>
										</div>
										<div class="mb-3">
											<label class="form-label" for="studentPw">비밀번호</label>
											<input class="form-control form-control-lg" type="password" id="studentPw" name="studentPw" />
											<div class="msg"></div>
										</div>
										<div class="mb-3">
