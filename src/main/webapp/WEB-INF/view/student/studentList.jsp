										...
										<tbody id="list">
											<c:forEach var="s" items="${list}">
												<tr>
													...
													<td>${s.studentId}</td>
													<td>${s.studentName}</td>
													<td><a rel="${s.studentName}" class="remove btn btn-sm btn-primary" href="${pageContext.request.contextPath}/employee/student/removeStudent?studentNo=${s.studentNo}">탈퇴</a></td>
												</tr>
											</c:forEach>
